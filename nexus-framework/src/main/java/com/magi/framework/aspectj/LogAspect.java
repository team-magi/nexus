package com.magi.framework.aspectj;
...
import com.magi.common.enums.BusinessStatus;
import com.magi.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.magi.common.annotation.Log)")
