...
import com.magi.common.json.JSONObject;
import com.magi.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        users.add(new UserFormModel(1, "1000001", "测试1", "18201571507"));
    ...
    {
        String[] array = { "nexus 1", "nexus 2", "nexus 3", "nexus 4", "nexus 5" };
        AjaxResult ajax = new AjaxResult();
